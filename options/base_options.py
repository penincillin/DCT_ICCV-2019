...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--aux_encoder', type=str, default='resnet18', help='selects model to use for auxiliary input, it could be IUV or segment')
        ...
        self.parser.add_argument('--dp_max_anno', type=int, default=200, help='max number of densepose annotations')
        self.parser.add_argument('--keypoints_num', type=int, default=19, help='number of keypoints')
        self.parser.add_argument('--joints_3d_num', type=int, default=14, help='number of keypoints')
        ...
        self.parser.add_argument('--pretrained_models_dir', type=str, default='/mnt/SSD/rongyu/data/3D_release/models/')
        ...
        self.parser.add_argument('--dpw_use3d', action='store_true', help='use 3d data of 3dpw dataset')
        self.parser.add_argument('--skip_smpl_pose', action='store_true', help="Not using smpl pose in training")
        self.parser.add_argument('--skip_smpl_shape', action='store_true', help="Not using smpl shape in training")
        self.parser.add_argument('--use_smpl_joints', action='store_true', help='use SMPL joints in training')
        self.parser.add_argument('--use_h36m_seq', action='store_true', help='use sequenced h36m dataset')
